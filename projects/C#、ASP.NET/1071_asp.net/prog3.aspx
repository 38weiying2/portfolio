...
<body>
    ...
    <form id="form1" runat="server">
        <div style="font-family: 微軟正黑體; font-weight: 600; height:1260px; position:absolute; left:50px; right:50px">
            ...
            <br />
            <div style="color:red;">您是失主身分!!!</div>
                    ...
                    筆資料<br />
                        ...
                        <asp:LinkButton ID="LinkButton1" runat="server" PostBackUrl="prog9.aspx">加入您的遺失物案件!!!</asp:LinkButton>
                        </center></br>
                    <br />
                    <br />
                    <br />
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:1071netdbConnectionString %>" SelectCommand="SELECT * FROM [s1061611Table5]">
                    </asp:SqlDataSource>
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:1071netdbConnectionString %>" SelectCommand="SELECT * FROM [s1061611Table5] WHERE ([內容] LIKE '%' + @內容 + '%')">
                        <SelectParameters>
