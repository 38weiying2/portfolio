...
let card1 = [
    [   
        ["網頁基礎應用1",["基本HTML","表單應用","CSS相關應用"],"From基礎程式設計","微簡介","../projects/1061_web1/index.html"],
        ["網頁基礎應用2",["基本HTML","CSS相關應用","基本javascript"],"From基礎程式設計","寵物食品購物網",""],
        ["Javascript",["運用chart.js製作圖表"],"From軟體專案管理實作","App市場分析",""],
        ["本網頁介紹",["javascript","bootstrap","RWD"],"From自行製作","介紹",""]
    ],
    [   
        ["Python數據分析",["123"],"From數據分析課程","天氣預測系統",""],
        ["Python數據分析",["K-Meams分群","機器學習","WordCloud做視覺化"],"From決策支援系統課","酒種建議清單",""],
        ["Python影像辨識、Linux",["影像辨識(ST-GCN)","深度學習(LSTM)","使用Linux系統"],"From畢業專題製作","人體運動姿勢辨識及矯正比對分析系統",""],
        ["Python數據分析",["Feature_Engineering","Feature_Selection","Modeling(判別合適之模型)"],"From數據分析課程(碩士)","影片觀看量預測系統",""],
...
function link(link,btntext){
    if(link == ""){
        return `<a class="mt-auto btn" onclick=alert('暫不開放')>${btntext}</a>`;
    }
    else{
        return `<a href="${link}" class="mt-auto btn">${btntext}</a>`;
    }
}
